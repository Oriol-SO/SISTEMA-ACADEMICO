...
<head>
  ...
  <title>Registro-add alumno </title>
...
<!-- DASHBOARD-->
  ...
  <li class="nav-item">
    ...
    <ul id="forms-nav" class="nav-content collapse show " data-bs-parent="#sidebar-nav">
      <li>
        <a href="addalumno.php" class="active">
...
<section class="section">
  <div class="row">
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Ingresa los datos del Alumno</h5>
          ...
          <form class="row g-3" method="post">
            ...
            <div class="col-md-6">
              <div class="col-md-12">
                <div class="form-floating">
                  <input type="text" class="form-control" id="floatingCity" placeholder="Sección" name="secc">
