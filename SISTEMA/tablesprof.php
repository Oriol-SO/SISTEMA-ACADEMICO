...
<!-- DASHBOARD-->
  ...
  <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show  " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tablesprof.php" class="active">
  ...
  <div class="row">
    ...
    <div class="card">
            <div class="card-body">
             ...
             <?php include('listas/tables_profe.php'); ?>             
              <!-- End Table with stripped rows -->
              <button type="button" onclick=" htmlexcel('tableprofe','docente');" class="btn btn-success">Descargar <i class="ri-download-fill"></i> </button>
            </div>
    </div>
