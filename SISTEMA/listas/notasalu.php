...
$consult1="SELECT CLASE.ID_SALON,SALON.ID_CURSO,CURSO.NOMBRE,PROMEDIO FROM CLASE INNER JOIN SALON ON CLASE.ID_SALON=SALON.ID_SALON INNER JOIN CURSO ON SALON.ID_CURSO=CURSO.ID_CURSO";
